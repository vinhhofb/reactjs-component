  ...
  return (
    <div className="App">
      ...
      <div className="container mx-auto">
        ...
        <Button buttonName="Search" color="bg-blue-700 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 hover:bg-blue-800" onClick={handleSubmit}/>
        <EmployeeTable/>
    </div>
  );
};
